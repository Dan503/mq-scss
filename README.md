...
$MQ-element__color--alt:
    (min, 1024px),//*$MQ-element__color--main doesn't go any higher than 1024px*/
    (inside, 980px, 600px)//*$MQ-element__color--main doesn't target screen sizes between 980px and 600px.*/
